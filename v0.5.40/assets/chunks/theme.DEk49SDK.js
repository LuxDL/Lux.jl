...
const _withScopeId$i = (n) => (pushScopeId("data-v-ccbd20cd"), n = n(), popScopeId(), n);
const _hoisted_1$P = { class: "NotFound" };
const _hoisted_2$y = { class: "code" };
const _hoisted_3$n = { class: "title" };
const _hoisted_4$e = /* @__PURE__ */ _withScopeId$i(() => /* @__PURE__ */ createBaseVNode("div", { class: "divider" }, null, -1));
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      if (localeLinks.value.length) {
        locale.value = localeLinks.value.find(({ link }) => link.startsWith(path)) || localeLinks.value[0];
      }
    });
    const notFound = computed(() => {
      ...
      return {
        ...
        ...locale.value.index === "root" ? (_a = site.value.themeConfig) == null ? void 0 : _a.notFound : (_d = (_c = (_b = site.value.locales) == null ? void 0 : _b[locale.value.index]) == null ? void 0 : _c.themeConfig) == null ? void 0 : _d.notFound
      };
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$P, [
        createBaseVNode("p", _hoisted_2$y, toDisplayString(notFound.value.code), 1),
        createBaseVNode("h1", _hoisted_3$n, toDisplayString(notFound.value.title), 1),
        _hoisted_4$e,
        createBaseVNode("blockquote", _hoisted_5$c, toDisplayString(notFound.value.quote), 1),
        createBaseVNode("div", _hoisted_6$9, [
          createBaseVNode("a", {
            class: "link",
            href: unref(withBase)(locale.value.link),
            "aria-label": notFound.value.linkLabel
          }, toDisplayString(notFound.value.linkText), 9, _hoisted_7$6)
        ])
      ]);
    };
  }
});
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["__scopeId", "data-v-ccbd20cd"]]);
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["__scopeId", "data-v-b6ca177b"]]);
...
const _withScopeId$g = (n) => (pushScopeId("data-v-b88cabfa"), n = n(), popScopeId(), n);
const _hoisted_1$J = {
  key: 0,
  class: "VPDocFooter"
};
...
const _hoisted_7$5 = /* @__PURE__ */ _withScopeId$g(() => /* @__PURE__ */ createBaseVNode("span", {
  class: "visually-hidden",
  id: "doc-footer-aria-label"
}, "Pager", -1));
const _hoisted_8$4 = { class: "pager" };
const _hoisted_9$2 = ["innerHTML"];
const _hoisted_10$2 = ["innerHTML"];
const _hoisted_11$1 = { class: "pager" };
...
const VPDocFooter = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["__scopeId", "data-v-b88cabfa"]]);
...
const _withScopeId$c = (n) => (pushScopeId("data-v-bc9dc845"), n = n(), popScopeId(), n);
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["__scopeId", "data-v-bc9dc845"]]);
...
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.ANroVfZo.js"), true ? __vite__mapDeps([0,1]) : void 0));
