...
@test ps_.layers.chain.layers.dense_1.weight == zeros(3, 2)
@test ps_.layers.chain.layers.dense_1.bias == zeros(3, 1)
@test ps_.layers.chain.layers.dense_2.weight == zeros(5, 3)
@test ps_.layers.chain.layers.dense_2.bias == zeros(5, 1)
@test ps_.layers.dense_3.weight != zeros(1, 5)
