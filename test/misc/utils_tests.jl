using Static, ComponentArrays, Optimisers, Functors
using Tracker, ReverseDiff, ForwardDiff
...
@testset "ComponentArrays edge cases" begin
...
@testset "Utils.init_rnn_hidden_state" begin
    rng = StableRNG(12345)
...
@testset "Recursive Utils (Deprecated)" begin
...
@testset "Tracing AD: AoS to SoA" begin
    rng = StableRNG(1234)
