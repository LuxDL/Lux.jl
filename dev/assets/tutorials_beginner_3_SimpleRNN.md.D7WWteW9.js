import{_ as a,c as i,o as n,al as p}from"./chunks/framework.BIqeusV3.js";const E=JSON.parse('{"title":"Training a Simple LSTM","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/beginner/3_SimpleRNN.md","filePath":"tutorials/beginner/3_SimpleRNN.md","lastUpdated":null}'),l={name:"tutorials/beginner/3_SimpleRNN.md"};function e(t,s,h,k,r,c){return n(),i("div",null,s[0]||(s[0]=[p(`<h1 id="Training-a-Simple-LSTM" tabindex="-1">Training a Simple LSTM <a class="header-anchor" href="#Training-a-Simple-LSTM" aria-label="Permalink to &quot;Training a Simple LSTM {#Training-a-Simple-LSTM}&quot;">​</a></h1><p>In this tutorial we will go over using a recurrent neural network to classify clockwise and anticlockwise spirals. By the end of this tutorial you will be able to:</p><ol><li><p>Create custom Lux models.</p></li><li><p>Become familiar with the Lux recurrent neural network API.</p></li><li><p>Training using Optimisers.jl and Zygote.jl.</p></li></ol><h2 id="Package-Imports" tabindex="-1">Package Imports <a class="header-anchor" href="#Package-Imports" aria-label="Permalink to &quot;Package Imports {#Package-Imports}&quot;">​</a></h2><p>Note: If you wish to use AutoZygote() for automatic differentiation, add Zygote to your project dependencies and include <code>using Zygote</code>.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> ADTypes, Lux, JLD2, MLUtils, Optimisers, Printf, Reactant, Random</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Precompiling Lux...</span></span>
<span class="line"><span>    554.1 ms  ✓ Requires</span></span>
<span class="line"><span>    531.0 ms  ✓ Compat</span></span>
<span class="line"><span>    583.6 ms  ✓ CpuId</span></span>
<span class="line"><span>    457.6 ms  ✓ JLLWrappers</span></span>
<span class="line"><span>    762.3 ms  ✓ Static</span></span>
<span class="line"><span>   1488.8 ms  ✓ DispatchDoctor</span></span>
<span class="line"><span>    373.3 ms  ✓ Compat → CompatLinearAlgebraExt</span></span>
<span class="line"><span>    385.9 ms  ✓ BitTwiddlingConvenienceFunctions</span></span>
<span class="line"><span>    608.7 ms  ✓ OpenSpecFun_jll</span></span>
<span class="line"><span>    398.3 ms  ✓ DispatchDoctor → DispatchDoctorEnzymeCoreExt</span></span>
<span class="line"><span>    969.8 ms  ✓ CPUSummary</span></span>
<span class="line"><span>    586.6 ms  ✓ Functors</span></span>
<span class="line"><span>   1194.7 ms  ✓ ChainRulesCore</span></span>
<span class="line"><span>   1285.6 ms  ✓ StaticArrayInterface</span></span>
<span class="line"><span>   1164.5 ms  ✓ LuxCore</span></span>
<span class="line"><span>    638.3 ms  ✓ PolyesterWeave</span></span>
<span class="line"><span>    817.4 ms  ✓ MLDataDevices</span></span>
<span class="line"><span>    391.2 ms  ✓ ADTypes → ADTypesChainRulesCoreExt</span></span>
<span class="line"><span>   2491.2 ms  ✓ SpecialFunctions</span></span>
<span class="line"><span>   7819.4 ms  ✓ StaticArrays</span></span>
<span class="line"><span>   1263.1 ms  ✓ Optimisers</span></span>
<span class="line"><span>    394.3 ms  ✓ ArrayInterface → ArrayInterfaceChainRulesCoreExt</span></span>
<span class="line"><span>   1243.1 ms  ✓ LogExpFunctions → LogExpFunctionsChainRulesCoreExt</span></span>
<span class="line"><span>    639.1 ms  ✓ DispatchDoctor → DispatchDoctorChainRulesCoreExt</span></span>
<span class="line"><span>    463.7 ms  ✓ CloseOpenIntervals</span></span>
<span class="line"><span>    564.5 ms  ✓ LayoutPointers</span></span>
<span class="line"><span>    460.2 ms  ✓ LuxCore → LuxCoreFunctorsExt</span></span>
<span class="line"><span>    591.0 ms  ✓ LuxCore → LuxCoreChainRulesCoreExt</span></span>
<span class="line"><span>    456.8 ms  ✓ LuxCore → LuxCoreEnzymeCoreExt</span></span>
<span class="line"><span>    443.3 ms  ✓ LuxCore → LuxCoreSetfieldExt</span></span>
<span class="line"><span>    617.6 ms  ✓ MLDataDevices → MLDataDevicesChainRulesCoreExt</span></span>
<span class="line"><span>    463.7 ms  ✓ LuxCore → LuxCoreMLDataDevicesExt</span></span>
<span class="line"><span>   1729.4 ms  ✓ SpecialFunctions → SpecialFunctionsChainRulesCoreExt</span></span>
<span class="line"><span>    742.8 ms  ✓ StaticArrays → StaticArraysChainRulesCoreExt</span></span>
<span class="line"><span>   2595.8 ms  ✓ WeightInitializers</span></span>
<span class="line"><span>    607.3 ms  ✓ StaticArrays → StaticArraysStatisticsExt</span></span>
<span class="line"><span>    607.2 ms  ✓ ConstructionBase → ConstructionBaseStaticArraysExt</span></span>
<span class="line"><span>    601.1 ms  ✓ Adapt → AdaptStaticArraysExt</span></span>
<span class="line"><span>   3529.3 ms  ✓ ForwardDiff</span></span>
<span class="line"><span>    653.9 ms  ✓ StaticArrayInterface → StaticArrayInterfaceStaticArraysExt</span></span>
<span class="line"><span>    414.7 ms  ✓ Optimisers → OptimisersEnzymeCoreExt</span></span>
<span class="line"><span>    423.2 ms  ✓ Optimisers → OptimisersAdaptExt</span></span>
<span class="line"><span>    850.0 ms  ✓ WeightInitializers → WeightInitializersChainRulesCoreExt</span></span>
<span class="line"><span>    925.9 ms  ✓ StrideArraysCore</span></span>
<span class="line"><span>    722.4 ms  ✓ Polyester</span></span>
<span class="line"><span>    813.4 ms  ✓ ForwardDiff → ForwardDiffStaticArraysExt</span></span>
<span class="line"><span>   4200.6 ms  ✓ KernelAbstractions</span></span>
<span class="line"><span>    670.7 ms  ✓ KernelAbstractions → LinearAlgebraExt</span></span>
<span class="line"><span>    781.4 ms  ✓ KernelAbstractions → EnzymeExt</span></span>
<span class="line"><span>   5280.4 ms  ✓ NNlib</span></span>
<span class="line"><span>    854.8 ms  ✓ NNlib → NNlibSpecialFunctionsExt</span></span>
<span class="line"><span>    874.1 ms  ✓ NNlib → NNlibEnzymeCoreExt</span></span>
<span class="line"><span>    893.4 ms  ✓ NNlib → NNlibForwardDiffExt</span></span>
<span class="line"><span>   5388.3 ms  ✓ LuxLib</span></span>
<span class="line"><span>   9491.9 ms  ✓ Lux</span></span>
...
<span class="line"><span>   4207.5 ms  ✓ FileIO</span></span>
<span class="line"><span>  33448.3 ms  ✓ JLD2</span></span>
<span class="line"><span>  2 dependencies successfully precompiled in 38 seconds. 32 already precompiled.</span></span>
<span class="line"><span>Precompiling MLUtils...</span></span>
<span class="line"><span>    418.6 ms  ✓ InverseFunctions → InverseFunctionsDatesExt</span></span>
<span class="line"><span>    410.2 ms  ✓ ContextVariablesX</span></span>
<span class="line"><span>   1037.2 ms  ✓ SimpleTraits</span></span>
<span class="line"><span>    616.9 ms  ✓ ChainRulesCore → ChainRulesCoreSparseArraysExt</span></span>
<span class="line"><span>   1682.9 ms  ✓ DataStructures</span></span>
<span class="line"><span>    932.8 ms  ✓ KernelAbstractions → SparseArraysExt</span></span>
<span class="line"><span>    621.1 ms  ✓ FLoopsBase</span></span>
<span class="line"><span>   3966.8 ms  ✓ Test</span></span>
<span class="line"><span>    932.6 ms  ✓ MLCore</span></span>
<span class="line"><span>    504.0 ms  ✓ SortingAlgorithms</span></span>
<span class="line"><span>    562.3 ms  ✓ InverseFunctions → InverseFunctionsTestExt</span></span>
<span class="line"><span>   2443.5 ms  ✓ Accessors</span></span>
<span class="line"><span>   1121.2 ms  ✓ SplittablesBase</span></span>
<span class="line"><span>    775.9 ms  ✓ Accessors → LinearAlgebraExt</span></span>
<span class="line"><span>    625.3 ms  ✓ Accessors → TestExt</span></span>
<span class="line"><span>    659.9 ms  ✓ Accessors → StaticArraysExt</span></span>
<span class="line"><span>   2189.1 ms  ✓ StatsBase</span></span>
<span class="line"><span>    757.5 ms  ✓ BangBang</span></span>
<span class="line"><span>    485.3 ms  ✓ BangBang → BangBangChainRulesCoreExt</span></span>
<span class="line"><span>    497.2 ms  ✓ BangBang → BangBangTablesExt</span></span>
<span class="line"><span>    679.2 ms  ✓ BangBang → BangBangStaticArraysExt</span></span>
<span class="line"><span>    909.3 ms  ✓ MicroCollections</span></span>
<span class="line"><span>   2820.3 ms  ✓ Transducers</span></span>
<span class="line"><span>    634.4 ms  ✓ Transducers → TransducersAdaptExt</span></span>
<span class="line"><span>   5197.6 ms  ✓ FLoops</span></span>
<span class="line"><span>   5827.5 ms  ✓ MLUtils</span></span>
...
<span class="line"><span>    661.7 ms  ✓ MLDataDevices → MLDataDevicesSparseArraysExt</span></span>
...
<span class="line"><span>   1505.0 ms  ✓ MLDataDevices → MLDataDevicesMLUtilsExt</span></span>
...
<span class="line"><span>   1998.1 ms  ✓ Lux → LuxMLUtilsExt</span></span>
...
<span class="line"><span>    436.4 ms  ✓ Scratch</span></span>
<span class="line"><span>    531.8 ms  ✓ LoggingExtras</span></span>
<span class="line"><span>    537.9 ms  ✓ ExceptionUnwrapping</span></span>
<span class="line"><span>   1027.4 ms  ✓ MbedTLS</span></span>
<span class="line"><span>    618.1 ms  ✓ OpenSSL_jll</span></span>
<span class="line"><span>    563.2 ms  ✓ LLVMOpenMP_jll</span></span>
<span class="line"><span>    593.8 ms  ✓ LibTracyClient_jll</span></span>
<span class="line"><span>   1523.5 ms  ✓ CUDA_Driver_jll</span></span>
<span class="line"><span>    958.2 ms  ✓ LazyArtifacts</span></span>
<span class="line"><span>    876.5 ms  ✓ Tracy</span></span>
<span class="line"><span>   1990.9 ms  ✓ OpenSSL</span></span>
<span class="line"><span>   1476.7 ms  ✓ Enzyme_jll</span></span>
<span class="line"><span>   1391.1 ms  ✓ LLVMExtra_jll</span></span>
<span class="line"><span>   2856.6 ms  ✓ Reactant_jll</span></span>
<span class="line"><span>   6404.4 ms  ✓ LLVM</span></span>
<span class="line"><span>  19618.2 ms  ✓ HTTP</span></span>
<span class="line"><span>  29152.9 ms  ✓ GPUCompiler</span></span>
<span class="line"><span>  96917.5 ms  ✓ Enzyme</span></span>
<span class="line"><span>   6709.7 ms  ✓ Enzyme → EnzymeGPUArraysCoreExt</span></span>
<span class="line"><span>  88266.1 ms  ✓ Reactant</span></span>
...
<span class="line"><span>   1739.7 ms  ✓ UnsafeAtomics → UnsafeAtomicsLLVM</span></span>
...
<span class="line"><span>   6706.7 ms  ✓ Enzyme → EnzymeSpecialFunctionsExt</span></span>
<span class="line"><span>   6580.6 ms  ✓ Enzyme → EnzymeLogExpFunctionsExt</span></span>
<span class="line"><span>   1233.9 ms  ✓ LuxLib → LuxLibEnzymeExt</span></span>
<span class="line"><span>  14545.7 ms  ✓ Enzyme → EnzymeChainRulesCoreExt</span></span>
<span class="line"><span>  14636.5 ms  ✓ Enzyme → EnzymeStaticArraysExt</span></span>
...
<span class="line"><span>   7552.8 ms  ✓ Lux → LuxEnzymeExt</span></span>
...
<span class="line"><span>   1742.0 ms  ✓ FileIO → HTTPExt</span></span>
...
<span class="line"><span>  16855.3 ms  ✓ Reactant → ReactantStatisticsExt</span></span>
<span class="line"><span>  19551.9 ms  ✓ Optimisers → OptimisersReactantExt</span></span>
...
<span class="line"><span>  17036.4 ms  ✓ LuxCore → LuxCoreReactantExt</span></span>
...
<span class="line"><span>  16935.5 ms  ✓ MLDataDevices → MLDataDevicesReactantExt</span></span>
...
<span class="line"><span>  16834.3 ms  ✓ Reactant → ReactantSpecialFunctionsExt</span></span>
<span class="line"><span>  17415.8 ms  ✓ Reactant → ReactantKernelAbstractionsExt</span></span>
<span class="line"><span>  17571.9 ms  ✓ LuxLib → LuxLibReactantExt</span></span>
<span class="line"><span>  16908.5 ms  ✓ Reactant → ReactantArrayInterfaceExt</span></span>
<span class="line"><span>  4 dependencies successfully precompiled in 34 seconds. 158 already precompiled.</span></span>
<span class="line"><span>Precompiling WeightInitializersReactantExt...</span></span>
<span class="line"><span>  16863.5 ms  ✓ WeightInitializers → WeightInitializersReactantExt</span></span>
...
<span class="line"><span>  19875.7 ms  ✓ Reactant → ReactantNNlibExt</span></span>
...
<span class="line"><span>  11959.2 ms  ✓ Lux → LuxReactantExt</span></span>
<span class="line"><span>  1 dependency successfully precompiled in 12 seconds. 180 already precompiled.</span></span></code></pre></div><h2 id="Dataset" tabindex="-1">Dataset <a class="header-anchor" href="#Dataset" aria-label="Permalink to &quot;Dataset {#Dataset}&quot;">​</a></h2><p>We will use MLUtils to generate 500 (noisy) clockwise and 500 (noisy) anticlockwise spirals. Using this data we will create a <code>MLUtils.DataLoader</code>. Our dataloader will give us sequences of size 2 × seq_len × batch_size and we need to predict a binary value whether the sequence is clockwise or anticlockwise.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> get_dataloaders</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(; dataset_size</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1000</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, sequence_length</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">50</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
...
<span class="line"><span>2025-07-03 02:37:09.659436: I external/xla/xla/service/service.cc:153] XLA service 0x4370a150 initialized for platform CUDA (this does not guarantee that XLA will be used). Devices:</span></span>
<span class="line"><span>2025-07-03 02:37:09.659480: I external/xla/xla/service/service.cc:161]   StreamExecutor device (0): NVIDIA A100-PCIE-40GB MIG 1g.5gb, Compute Capability 8.0</span></span>
<span class="line"><span>WARNING: All log messages before absl::InitializeLog() is called are written to STDERR</span></span>
<span class="line"><span>I0000 00:00:1751510229.660183 2340468 se_gpu_pjrt_client.cc:1370] Using BFC allocator.</span></span>
<span class="line"><span>I0000 00:00:1751510229.660249 2340468 gpu_helpers.cc:136] XLA backend allocating 3825205248 bytes on device 0 for BFCAllocator.</span></span>
<span class="line"><span>I0000 00:00:1751510229.660284 2340468 gpu_helpers.cc:177] XLA backend will use up to 1275068416 bytes on device 0 for CollectiveBFCAllocator.</span></span>
<span class="line"><span>I0000 00:00:1751510229.672827 2340468 cuda_dnn.cc:471] Loaded cuDNN version 90800</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.53871</span></span>
<span class="line"><span>Validation:	Loss 0.45530	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.41275</span></span>
<span class="line"><span>Validation:	Loss 0.36879	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.33084</span></span>
<span class="line"><span>Validation:	Loss 0.30396	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.26609</span></span>
<span class="line"><span>Validation:	Loss 0.23714	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.19188</span></span>
<span class="line"><span>Validation:	Loss 0.15937	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.13203</span></span>
<span class="line"><span>Validation:	Loss 0.11787	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.10095</span></span>
...
<span class="line"><span>Validation:	Loss 0.07281	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.06196</span></span>
<span class="line"><span>Validation:	Loss 0.05599	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 10]: Loss 0.04727</span></span>
<span class="line"><span>Validation:	Loss 0.04213	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 11]: Loss 0.03566</span></span>
<span class="line"><span>Validation:	Loss 0.03229	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 12]: Loss 0.02835</span></span>
<span class="line"><span>Validation:	Loss 0.02690	Accuracy 1.00000</span></span>
...
<span class="line"><span>Epoch [ 15]: Loss 0.01778</span></span>
...
<span class="line"><span>Epoch [ 25]: Loss 0.00600</span></span>
<span class="line"><span>Validation:	Loss 0.00574	Accuracy 1.00000</span></span></code></pre></div><p>We can also train the compact model with the exact same code!</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ps_trained2, st_trained2 </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> main</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(SpiralClassifierCompact)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: \`replicate\` doesn&#39;t work for \`TaskLocalRNG\`. Returning the same \`TaskLocalRNG\`.</span></span>
<span class="line"><span>└ @ LuxCore /var/lib/buildkite-agent/builds/gpuci-5/julialang/lux-dot-jl/lib/LuxCore/src/LuxCore.jl:18</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.63710</span></span>
<span class="line"><span>Validation:	Loss 0.53754	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.49361</span></span>
<span class="line"><span>Validation:	Loss 0.43955	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.42056</span></span>
<span class="line"><span>Validation:	Loss 0.38285	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.36925</span></span>
<span class="line"><span>Validation:	Loss 0.33864	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.32871</span></span>
<span class="line"><span>Validation:	Loss 0.30168	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.29669</span></span>
<span class="line"><span>Validation:	Loss 0.26877	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.26218</span></span>
<span class="line"><span>Validation:	Loss 0.23851	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.23271</span></span>
<span class="line"><span>Validation:	Loss 0.21128	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.20542</span></span>
<span class="line"><span>Validation:	Loss 0.18735	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 10]: Loss 0.18283</span></span>
<span class="line"><span>Validation:	Loss 0.16648	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 11]: Loss 0.16256</span></span>
<span class="line"><span>Validation:	Loss 0.14829	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 12]: Loss 0.14543</span></span>
<span class="line"><span>Validation:	Loss 0.13233	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 13]: Loss 0.12940</span></span>
<span class="line"><span>Validation:	Loss 0.11818	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 14]: Loss 0.11614</span></span>
<span class="line"><span>Validation:	Loss 0.10567	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 15]: Loss 0.10393</span></span>
<span class="line"><span>Validation:	Loss 0.09468	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 16]: Loss 0.09253</span></span>
<span class="line"><span>Validation:	Loss 0.08485	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 17]: Loss 0.08299</span></span>
<span class="line"><span>Validation:	Loss 0.07556	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 18]: Loss 0.07376</span></span>
<span class="line"><span>Validation:	Loss 0.06626	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 19]: Loss 0.06441</span></span>
<span class="line"><span>Validation:	Loss 0.05749	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 20]: Loss 0.05547</span></span>
<span class="line"><span>Validation:	Loss 0.05007	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 21]: Loss 0.04844</span></span>
<span class="line"><span>Validation:	Loss 0.04406	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 22]: Loss 0.04271</span></span>
<span class="line"><span>Validation:	Loss 0.03904	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 23]: Loss 0.03800</span></span>
<span class="line"><span>Validation:	Loss 0.03483	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 24]: Loss 0.03382</span></span>
<span class="line"><span>Validation:	Loss 0.03124	Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 25]: Loss 0.03031</span></span>
<span class="line"><span>Validation:	Loss 0.02809	Accuracy 1.00000</span></span></code></pre></div><h2 id="Saving-the-Model" tabindex="-1">Saving the Model <a class="header-anchor" href="#Saving-the-Model" aria-label="Permalink to &quot;Saving the Model {#Saving-the-Model}&quot;">​</a></h2><p>We can save the model using JLD2 (and any other serialization library of your choice) Note that we transfer the model to CPU before saving. Additionally, we recommend that you don&#39;t save the model struct and only save the parameters and states.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">@save</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;trained_model.jld2&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> ps_trained st_trained</span></span></code></pre></div><p>Let&#39;s try loading the model</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">@load</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;trained_model.jld2&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> ps_trained st_trained</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>2-element Vector{Symbol}:</span></span>
