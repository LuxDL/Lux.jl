import{_ as a,c as n,o as i,al as p}from"./chunks/framework.atLBEsZl.js";const E=JSON.parse('{"title":"MNIST Classification with SimpleChains","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/beginner/4_SimpleChains.md","filePath":"tutorials/beginner/4_SimpleChains.md","lastUpdated":null}'),l={name:"tutorials/beginner/4_SimpleChains.md"};function e(t,s,h,r,c,k){return i(),n("div",null,s[0]||(s[0]=[p(`<h1 id="MNIST-Classification-with-SimpleChains" tabindex="-1">MNIST Classification with SimpleChains <a class="header-anchor" href="#MNIST-Classification-with-SimpleChains" aria-label="Permalink to &quot;MNIST Classification with SimpleChains {#MNIST-Classification-with-SimpleChains}&quot;">​</a></h1><p>SimpleChains.jl is an excellent framework for training small neural networks. In this tutorial we will demonstrate how to use the same API as Lux.jl to train a model using SimpleChains.jl. We will use the tutorial from <a href="https://pumasai.github.io/SimpleChains.jl/dev/examples/mnist/" target="_blank" rel="noreferrer">SimpleChains.jl</a> as a reference.</p><h2 id="Package-Imports" tabindex="-1">Package Imports <a class="header-anchor" href="#Package-Imports" aria-label="Permalink to &quot;Package Imports {#Package-Imports}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Lux, MLUtils, Optimisers, Zygote, OneHotArrays, Random, Statistics, Printf, Reactant</span></span>
...
<span class="line"><span>    430.8 ms  ✓ ConcreteStructs</span></span>
<span class="line"><span>    399.0 ms  ✓ Future</span></span>
<span class="line"><span>    375.8 ms  ✓ OpenLibm_jll</span></span>
<span class="line"><span>    574.2 ms  ✓ ADTypes</span></span>
<span class="line"><span>    498.6 ms  ✓ Statistics</span></span>
<span class="line"><span>    407.3 ms  ✓ ArgCheck</span></span>
<span class="line"><span>   1649.8 ms  ✓ UnsafeAtomics</span></span>
<span class="line"><span>    442.3 ms  ✓ CompilerSupportLibraries_jll</span></span>
<span class="line"><span>    368.9 ms  ✓ ManualMemory</span></span>
<span class="line"><span>    316.1 ms  ✓ Reexport</span></span>
<span class="line"><span>    301.9 ms  ✓ SIMDTypes</span></span>
<span class="line"><span>    490.5 ms  ✓ DocStringExtensions</span></span>
<span class="line"><span>    353.1 ms  ✓ HashArrayMappedTries</span></span>
<span class="line"><span>    523.3 ms  ✓ EnzymeCore</span></span>
<span class="line"><span>   1147.3 ms  ✓ IrrationalConstants</span></span>
<span class="line"><span>   2307.0 ms  ✓ MacroTools</span></span>
<span class="line"><span>    294.1 ms  ✓ IfElse</span></span>
<span class="line"><span>    397.0 ms  ✓ ConstructionBase</span></span>
<span class="line"><span>    323.4 ms  ✓ CommonWorldInvalidations</span></span>
<span class="line"><span>    421.3 ms  ✓ Adapt</span></span>
<span class="line"><span>    338.5 ms  ✓ FastClosures</span></span>
<span class="line"><span>    396.7 ms  ✓ StaticArraysCore</span></span>
<span class="line"><span>    605.6 ms  ✓ CpuId</span></span>
<span class="line"><span>    508.5 ms  ✓ Compat</span></span>
<span class="line"><span>    444.0 ms  ✓ NaNMath</span></span>
<span class="line"><span>    455.7 ms  ✓ Atomix</span></span>
<span class="line"><span>    583.8 ms  ✓ OpenSpecFun_jll</span></span>
<span class="line"><span>    325.4 ms  ✓ ScopedValues</span></span>
<span class="line"><span>    356.4 ms  ✓ ADTypes → ADTypesEnzymeCoreExt</span></span>
<span class="line"><span>    805.5 ms  ✓ ThreadingUtilities</span></span>
<span class="line"><span>    560.7 ms  ✓ LogExpFunctions</span></span>
<span class="line"><span>    632.0 ms  ✓ CommonSubexpressions</span></span>
<span class="line"><span>    362.3 ms  ✓ ConstructionBase → ConstructionBaseLinearAlgebraExt</span></span>
<span class="line"><span>    362.0 ms  ✓ ADTypes → ADTypesConstructionBaseExt</span></span>
<span class="line"><span>    507.8 ms  ✓ ArrayInterface</span></span>
<span class="line"><span>    771.6 ms  ✓ Static</span></span>
<span class="line"><span>   1575.7 ms  ✓ DispatchDoctor</span></span>
<span class="line"><span>    353.3 ms  ✓ EnzymeCore → AdaptExt</span></span>
<span class="line"><span>    423.6 ms  ✓ GPUArraysCore</span></span>
<span class="line"><span>    429.4 ms  ✓ DiffResults</span></span>
<span class="line"><span>    359.5 ms  ✓ Compat → CompatLinearAlgebraExt</span></span>
<span class="line"><span>   1406.3 ms  ✓ Setfield</span></span>
<span class="line"><span>    341.6 ms  ✓ ArrayInterface → ArrayInterfaceStaticArraysCoreExt</span></span>
<span class="line"><span>   2403.7 ms  ✓ SpecialFunctions</span></span>
<span class="line"><span>    392.7 ms  ✓ BitTwiddlingConvenienceFunctions</span></span>
<span class="line"><span>    398.2 ms  ✓ DispatchDoctor → DispatchDoctorEnzymeCoreExt</span></span>
<span class="line"><span>    350.2 ms  ✓ ArrayInterface → ArrayInterfaceGPUArraysCoreExt</span></span>
<span class="line"><span>    952.0 ms  ✓ CPUSummary</span></span>
<span class="line"><span>    598.8 ms  ✓ Functors</span></span>
<span class="line"><span>   1183.1 ms  ✓ ChainRulesCore</span></span>
<span class="line"><span>   1192.1 ms  ✓ StaticArrayInterface</span></span>
<span class="line"><span>   1121.1 ms  ✓ LuxCore</span></span>
<span class="line"><span>    594.8 ms  ✓ DiffRules</span></span>
<span class="line"><span>    616.1 ms  ✓ PolyesterWeave</span></span>
<span class="line"><span>   7066.4 ms  ✓ StaticArrays</span></span>
<span class="line"><span>    784.9 ms  ✓ MLDataDevices</span></span>
<span class="line"><span>    390.1 ms  ✓ ADTypes → ADTypesChainRulesCoreExt</span></span>
<span class="line"><span>   2571.6 ms  ✓ WeightInitializers</span></span>
<span class="line"><span>   1233.7 ms  ✓ Optimisers</span></span>
<span class="line"><span>    380.6 ms  ✓ ArrayInterface → ArrayInterfaceChainRulesCoreExt</span></span>
<span class="line"><span>   1204.1 ms  ✓ LogExpFunctions → LogExpFunctionsChainRulesCoreExt</span></span>
<span class="line"><span>    590.5 ms  ✓ DispatchDoctor → DispatchDoctorChainRulesCoreExt</span></span>
<span class="line"><span>    435.1 ms  ✓ CloseOpenIntervals</span></span>
<span class="line"><span>    553.3 ms  ✓ LayoutPointers</span></span>
<span class="line"><span>    427.6 ms  ✓ LuxCore → LuxCoreFunctorsExt</span></span>
<span class="line"><span>    567.5 ms  ✓ LuxCore → LuxCoreChainRulesCoreExt</span></span>
<span class="line"><span>   1560.4 ms  ✓ SpecialFunctions → SpecialFunctionsChainRulesCoreExt</span></span>
<span class="line"><span>    427.6 ms  ✓ LuxCore → LuxCoreSetfieldExt</span></span>
<span class="line"><span>    460.2 ms  ✓ LuxCore → LuxCoreEnzymeCoreExt</span></span>
<span class="line"><span>    592.9 ms  ✓ StaticArrays → StaticArraysStatisticsExt</span></span>
<span class="line"><span>    638.0 ms  ✓ StaticArrays → StaticArraysChainRulesCoreExt</span></span>
<span class="line"><span>    591.2 ms  ✓ ConstructionBase → ConstructionBaseStaticArraysExt</span></span>
<span class="line"><span>    574.5 ms  ✓ Adapt → AdaptStaticArraysExt</span></span>
<span class="line"><span>    602.1 ms  ✓ MLDataDevices → MLDataDevicesChainRulesCoreExt</span></span>
<span class="line"><span>    630.4 ms  ✓ StaticArrayInterface → StaticArrayInterfaceStaticArraysExt</span></span>
<span class="line"><span>    434.3 ms  ✓ LuxCore → LuxCoreMLDataDevicesExt</span></span>
<span class="line"><span>    828.8 ms  ✓ WeightInitializers → WeightInitializersChainRulesCoreExt</span></span>
<span class="line"><span>    401.5 ms  ✓ Optimisers → OptimisersEnzymeCoreExt</span></span>
<span class="line"><span>    397.5 ms  ✓ Optimisers → OptimisersAdaptExt</span></span>
<span class="line"><span>   3424.5 ms  ✓ ForwardDiff</span></span>
<span class="line"><span>    854.3 ms  ✓ StrideArraysCore</span></span>
<span class="line"><span>    808.5 ms  ✓ ForwardDiff → ForwardDiffStaticArraysExt</span></span>
<span class="line"><span>    709.4 ms  ✓ Polyester</span></span>
<span class="line"><span>   3980.5 ms  ✓ KernelAbstractions</span></span>
<span class="line"><span>    660.2 ms  ✓ KernelAbstractions → LinearAlgebraExt</span></span>
<span class="line"><span>    716.4 ms  ✓ KernelAbstractions → EnzymeExt</span></span>
<span class="line"><span>   5246.4 ms  ✓ NNlib</span></span>
<span class="line"><span>    860.9 ms  ✓ NNlib → NNlibSpecialFunctionsExt</span></span>
<span class="line"><span>    881.2 ms  ✓ NNlib → NNlibEnzymeCoreExt</span></span>
<span class="line"><span>    895.3 ms  ✓ NNlib → NNlibForwardDiffExt</span></span>
<span class="line"><span>   5448.2 ms  ✓ LuxLib</span></span>
<span class="line"><span>   9204.9 ms  ✓ Lux</span></span>
<span class="line"><span>  92 dependencies successfully precompiled in 47 seconds. 13 already precompiled.</span></span>
<span class="line"><span>Precompiling MLUtils...</span></span>
<span class="line"><span>    450.2 ms  ✓ SuiteSparse_jll</span></span>
<span class="line"><span>    536.3 ms  ✓ OrderedCollections</span></span>
<span class="line"><span>    551.7 ms  ✓ Serialization</span></span>
<span class="line"><span>    425.3 ms  ✓ DelimitedFiles</span></span>
<span class="line"><span>    375.1 ms  ✓ LogExpFunctions → LogExpFunctionsInverseFunctionsExt</span></span>
<span class="line"><span>    389.5 ms  ✓ InverseFunctions → InverseFunctionsDatesExt</span></span>
<span class="line"><span>    387.9 ms  ✓ ContextVariablesX</span></span>
<span class="line"><span>    772.1 ms  ✓ Tables</span></span>
<span class="line"><span>    995.9 ms  ✓ SimpleTraits</span></span>
<span class="line"><span>   1625.2 ms  ✓ DataStructures</span></span>
<span class="line"><span>   1891.2 ms  ✓ Distributed</span></span>
<span class="line"><span>   3673.7 ms  ✓ SparseArrays</span></span>
<span class="line"><span>   2396.8 ms  ✓ Accessors</span></span>
<span class="line"><span>    580.8 ms  ✓ FLoopsBase</span></span>
<span class="line"><span>    503.0 ms  ✓ SortingAlgorithms</span></span>
<span class="line"><span>   3727.6 ms  ✓ Test</span></span>
<span class="line"><span>    952.4 ms  ✓ MLCore</span></span>
<span class="line"><span>    616.2 ms  ✓ Statistics → SparseArraysExt</span></span>
<span class="line"><span>    600.7 ms  ✓ Adapt → AdaptSparseArraysExt</span></span>
<span class="line"><span>    634.8 ms  ✓ ChainRulesCore → ChainRulesCoreSparseArraysExt</span></span>
<span class="line"><span>    796.8 ms  ✓ Accessors → LinearAlgebraExt</span></span>
<span class="line"><span>    931.8 ms  ✓ KernelAbstractions → SparseArraysExt</span></span>
<span class="line"><span>    670.5 ms  ✓ Accessors → StaticArraysExt</span></span>
<span class="line"><span>    598.6 ms  ✓ InverseFunctions → InverseFunctionsTestExt</span></span>
<span class="line"><span>    618.1 ms  ✓ Accessors → TestExt</span></span>
<span class="line"><span>   1084.1 ms  ✓ SplittablesBase</span></span>
<span class="line"><span>    750.5 ms  ✓ BangBang</span></span>
<span class="line"><span>    486.7 ms  ✓ BangBang → BangBangChainRulesCoreExt</span></span>
<span class="line"><span>    674.4 ms  ✓ BangBang → BangBangStaticArraysExt</span></span>
<span class="line"><span>    486.4 ms  ✓ BangBang → BangBangTablesExt</span></span>
<span class="line"><span>   2145.1 ms  ✓ StatsBase</span></span>
<span class="line"><span>    885.5 ms  ✓ MicroCollections</span></span>
<span class="line"><span>   2677.1 ms  ✓ Transducers</span></span>
<span class="line"><span>    640.7 ms  ✓ Transducers → TransducersAdaptExt</span></span>
<span class="line"><span>   5010.9 ms  ✓ FLoops</span></span>
<span class="line"><span>   6478.7 ms  ✓ MLUtils</span></span>
...
<span class="line"><span>    606.1 ms  ✓ ArrayInterface → ArrayInterfaceSparseArraysExt</span></span>
...
<span class="line"><span>    647.2 ms  ✓ MLDataDevices → MLDataDevicesSparseArraysExt</span></span>
...
<span class="line"><span>   1666.1 ms  ✓ MLDataDevices → MLDataDevicesMLUtilsExt</span></span>
...
<span class="line"><span>   2049.3 ms  ✓ Lux → LuxMLUtilsExt</span></span>
...
<span class="line"><span>    411.1 ms  ✓ FillArrays → FillArraysStatisticsExt</span></span>
<span class="line"><span>    587.4 ms  ✓ SuiteSparse</span></span>
<span class="line"><span>    671.9 ms  ✓ FillArrays → FillArraysSparseArraysExt</span></span>
<span class="line"><span>    431.9 ms  ✓ AbstractFFTs → AbstractFFTsChainRulesCoreExt</span></span>
<span class="line"><span>    742.7 ms  ✓ StructArrays</span></span>
<span class="line"><span>    677.0 ms  ✓ SparseInverseSubset</span></span>
<span class="line"><span>   1002.0 ms  ✓ ZygoteRules</span></span>
<span class="line"><span>    424.4 ms  ✓ StructArrays → StructArraysAdaptExt</span></span>
<span class="line"><span>   1844.8 ms  ✓ IRTools</span></span>
<span class="line"><span>    409.8 ms  ✓ StructArrays → StructArraysLinearAlgebraExt</span></span>
<span class="line"><span>    631.7 ms  ✓ StructArrays → StructArraysSparseArraysExt</span></span>
<span class="line"><span>   5350.2 ms  ✓ ChainRules</span></span>
<span class="line"><span>  34290.5 ms  ✓ Zygote</span></span>
<span class="line"><span>  13 dependencies successfully precompiled in 43 seconds. 52 already precompiled.</span></span>
<span class="line"><span>Precompiling StructArraysExt...</span></span>
<span class="line"><span>    525.1 ms  ✓ Accessors → StructArraysExt</span></span>
...
<span class="line"><span>    498.4 ms  ✓ BangBang → BangBangStructArraysExt</span></span>
...
<span class="line"><span>    682.5 ms  ✓ StructArrays → StructArraysStaticArraysExt</span></span>
...
<span class="line"><span>    741.7 ms  ✓ StructArrays → StructArraysGPUArraysCoreExt</span></span>
...
<span class="line"><span>    775.1 ms  ✓ ArrayInterface → ArrayInterfaceChainRulesExt</span></span>
...
<span class="line"><span>    815.5 ms  ✓ MLDataDevices → MLDataDevicesChainRulesExt</span></span>
...
<span class="line"><span>    471.8 ms  ✓ MLDataDevices → MLDataDevicesFillArraysExt</span></span>
...
<span class="line"><span>   1467.0 ms  ✓ AbstractFFTs → AbstractFFTsTestExt</span></span>
<span class="line"><span>  1 dependency successfully precompiled in 2 seconds. 7 already precompiled.</span></span>
<span class="line"><span>Precompiling MLDataDevicesZygoteExt...</span></span>
<span class="line"><span>   1765.4 ms  ✓ MLDataDevices → MLDataDevicesZygoteExt</span></span>
...
<span class="line"><span>   2633.5 ms  ✓ Lux → LuxZygoteExt</span></span>
...
<span class="line"><span>    742.4 ms  ✓ MLDataDevices → MLDataDevicesOneHotArraysExt</span></span>
...
<span class="line"><span>    374.1 ms  ✓ CEnum</span></span>
<span class="line"><span>    391.4 ms  ✓ ExprTools</span></span>
<span class="line"><span>    352.1 ms  ✓ EnumX</span></span>
<span class="line"><span>    367.3 ms  ✓ StructIO</span></span>
<span class="line"><span>    771.9 ms  ✓ ExpressionExplorer</span></span>
<span class="line"><span>    354.3 ms  ✓ SimpleBufferStream</span></span>
<span class="line"><span>    407.2 ms  ✓ Zlib_jll</span></span>
<span class="line"><span>    639.1 ms  ✓ URIs</span></span>
<span class="line"><span>    393.8 ms  ✓ BitFlags</span></span>
<span class="line"><span>    535.7 ms  ✓ TranscodingStreams</span></span>
<span class="line"><span>    427.6 ms  ✓ Scratch</span></span>
<span class="line"><span>    756.7 ms  ✓ ConcurrentUtilities</span></span>
<span class="line"><span>   1069.9 ms  ✓ MbedTLS</span></span>
<span class="line"><span>    522.0 ms  ✓ LoggingExtras</span></span>
<span class="line"><span>    501.8 ms  ✓ ExceptionUnwrapping</span></span>
<span class="line"><span>    604.4 ms  ✓ LLVMOpenMP_jll</span></span>
<span class="line"><span>    634.9 ms  ✓ OpenSSL_jll</span></span>
<span class="line"><span>    621.9 ms  ✓ LibTracyClient_jll</span></span>
<span class="line"><span>    635.9 ms  ✓ ReactantCore</span></span>
<span class="line"><span>   1039.9 ms  ✓ LazyArtifacts</span></span>
<span class="line"><span>    502.6 ms  ✓ CodecZlib</span></span>
<span class="line"><span>   2005.1 ms  ✓ ObjectFile</span></span>
<span class="line"><span>   1556.5 ms  ✓ CUDA_Driver_jll</span></span>
<span class="line"><span>    925.1 ms  ✓ Tracy</span></span>
<span class="line"><span>   1410.9 ms  ✓ Enzyme_jll</span></span>
<span class="line"><span>   2098.7 ms  ✓ OpenSSL</span></span>
<span class="line"><span>   1421.9 ms  ✓ LLVMExtra_jll</span></span>
<span class="line"><span>   2977.0 ms  ✓ Reactant_jll</span></span>
<span class="line"><span>   6902.9 ms  ✓ LLVM</span></span>
<span class="line"><span>  19515.5 ms  ✓ HTTP</span></span>
<span class="line"><span>  30718.2 ms  ✓ GPUCompiler</span></span>
<span class="line"><span>  97497.9 ms  ✓ Enzyme</span></span>
<span class="line"><span>   7135.1 ms  ✓ Enzyme → EnzymeGPUArraysCoreExt</span></span>
<span class="line"><span>  89636.5 ms  ✓ Reactant</span></span>
<span class="line"><span>  34 dependencies successfully precompiled in 240 seconds. 46 already precompiled.</span></span>
<span class="line"><span>Precompiling UnsafeAtomicsLLVM...</span></span>
<span class="line"><span>   1744.0 ms  ✓ UnsafeAtomics → UnsafeAtomicsLLVM</span></span>
...
<span class="line"><span>   6902.3 ms  ✓ Enzyme → EnzymeSpecialFunctionsExt</span></span>
<span class="line"><span>   6915.5 ms  ✓ Enzyme → EnzymeLogExpFunctionsExt</span></span>
<span class="line"><span>  14681.7 ms  ✓ Enzyme → EnzymeChainRulesCoreExt</span></span>
<span class="line"><span>  14686.1 ms  ✓ Enzyme → EnzymeStaticArraysExt</span></span>
<span class="line"><span>   1245.0 ms  ✓ LuxLib → LuxLibEnzymeExt</span></span>
...
<span class="line"><span>   7718.3 ms  ✓ Lux → LuxEnzymeExt</span></span>
...
<span class="line"><span>  16865.5 ms  ✓ Reactant → ReactantStatisticsExt</span></span>
<span class="line"><span>  20390.7 ms  ✓ Optimisers → OptimisersReactantExt</span></span>
...
<span class="line"><span>  17438.2 ms  ✓ LuxCore → LuxCoreReactantExt</span></span>
...
<span class="line"><span>  17693.2 ms  ✓ MLDataDevices → MLDataDevicesReactantExt</span></span>
...
<span class="line"><span>  17527.2 ms  ✓ Reactant → ReactantSpecialFunctionsExt</span></span>
<span class="line"><span>  18001.5 ms  ✓ Reactant → ReactantKernelAbstractionsExt</span></span>
<span class="line"><span>  18200.4 ms  ✓ LuxLib → LuxLibReactantExt</span></span>
<span class="line"><span>  18653.0 ms  ✓ Reactant → ReactantArrayInterfaceExt</span></span>
<span class="line"><span>  4 dependencies successfully precompiled in 37 seconds. 158 already precompiled.</span></span>
<span class="line"><span>Precompiling WeightInitializersReactantExt...</span></span>
<span class="line"><span>  18938.7 ms  ✓ WeightInitializers → WeightInitializersReactantExt</span></span>
<span class="line"><span>  1 dependency successfully precompiled in 19 seconds. 96 already precompiled.</span></span>
<span class="line"><span>Precompiling ReactantAbstractFFTsExt...</span></span>
<span class="line"><span>  18410.1 ms  ✓ Reactant → ReactantAbstractFFTsExt</span></span>
<span class="line"><span>  1 dependency successfully precompiled in 19 seconds. 82 already precompiled.</span></span>
<span class="line"><span>Precompiling ReactantOneHotArraysExt...</span></span>
<span class="line"><span>  17950.1 ms  ✓ Reactant → ReactantOneHotArraysExt</span></span>
...
<span class="line"><span>  20228.0 ms  ✓ Reactant → ReactantNNlibExt</span></span>
...
<span class="line"><span>  12565.1 ms  ✓ Lux → LuxReactantExt</span></span>
...
<span class="line"><span>    416.1 ms  ✓ OffsetArrays → OffsetArraysAdaptExt</span></span>
<span class="line"><span>    761.8 ms  ✓ GZip</span></span>
<span class="line"><span>    610.7 ms  ✓ ZipFile</span></span>
<span class="line"><span>    552.5 ms  ✓ BFloat16s</span></span>
<span class="line"><span>    482.3 ms  ✓ PooledArrays</span></span>
<span class="line"><span>    459.7 ms  ✓ StridedViews</span></span>
<span class="line"><span>   2262.5 ms  ✓ FixedPointNumbers</span></span>
<span class="line"><span>    811.0 ms  ✓ StructTypes</span></span>
<span class="line"><span>   1378.2 ms  ✓ SentinelArrays</span></span>
<span class="line"><span>    581.8 ms  ✓ MPIPreferences</span></span>
<span class="line"><span>    598.5 ms  ✓ Chemfiles_jll</span></span>
<span class="line"><span>    636.4 ms  ✓ libaec_jll</span></span>
<span class="line"><span>    602.9 ms  ✓ Hwloc_jll</span></span>
<span class="line"><span>    470.2 ms  ✓ MicrosoftMPI_jll</span></span>
<span class="line"><span>    614.8 ms  ✓ Libiconv_jll</span></span>
<span class="line"><span>   1020.1 ms  ✓ FilePathsBase</span></span>
<span class="line"><span>   2005.2 ms  ✓ StringManipulation</span></span>
<span class="line"><span>    507.1 ms  ✓ InlineStrings → ParsersExt</span></span>
<span class="line"><span>   3104.2 ms  ✓ DataDeps</span></span>
<span class="line"><span>   4297.9 ms  ✓ FileIO</span></span>
<span class="line"><span>    367.2 ms  ✓ StridedViews → StridedViewsPtrArraysExt</span></span>
<span class="line"><span>   1548.0 ms  ✓ ColorTypes</span></span>
<span class="line"><span>   1160.1 ms  ✓ MPItrampoline_jll</span></span>
<span class="line"><span>   1285.2 ms  ✓ OpenMPI_jll</span></span>
<span class="line"><span>   1379.4 ms  ✓ MPICH_jll</span></span>
<span class="line"><span>    547.9 ms  ✓ StringEncodings</span></span>
<span class="line"><span>    529.2 ms  ✓ FilePathsBase → FilePathsBaseMmapExt</span></span>
<span class="line"><span>   1192.0 ms  ✓ FilePathsBase → FilePathsBaseTestExt</span></span>
<span class="line"><span>   9278.8 ms  ✓ JSON3</span></span>
<span class="line"><span>    839.6 ms  ✓ WeakRefStrings</span></span>
<span class="line"><span>   1760.8 ms  ✓ FileIO → HTTPExt</span></span>
<span class="line"><span>  20753.3 ms  ✓ Unitful</span></span>
<span class="line"><span>   1465.2 ms  ✓ NPZ</span></span>
<span class="line"><span>   2042.7 ms  ✓ ColorVectorSpace</span></span>
<span class="line"><span>   4593.1 ms  ✓ Colors</span></span>
<span class="line"><span>   1928.3 ms  ✓ HDF5_jll</span></span>
<span class="line"><span>   2514.6 ms  ✓ Pickle</span></span>
<span class="line"><span>  19885.3 ms  ✓ PrettyTables</span></span>
<span class="line"><span>    577.1 ms  ✓ Unitful → ConstructionBaseUnitfulExt</span></span>
<span class="line"><span>    583.5 ms  ✓ Unitful → InverseFunctionsUnitfulExt</span></span>
<span class="line"><span>    641.3 ms  ✓ Unitful → PrintfExt</span></span>
<span class="line"><span>    598.0 ms  ✓ Accessors → UnitfulExt</span></span>
<span class="line"><span>  18745.3 ms  ✓ CSV</span></span>
<span class="line"><span>   3899.9 ms  ✓ ColorSchemes</span></span>
<span class="line"><span>  34621.9 ms  ✓ JLD2</span></span>
<span class="line"><span>  19641.6 ms  ✓ ImageCore</span></span>
<span class="line"><span>   2692.0 ms  ✓ UnitfulAtomic</span></span>
<span class="line"><span>   2292.2 ms  ✓ PeriodicTable</span></span>
<span class="line"><span>   7322.7 ms  ✓ HDF5</span></span>
<span class="line"><span>   2034.8 ms  ✓ ImageBase</span></span>
<span class="line"><span>   2418.1 ms  ✓ AtomsBase</span></span>
<span class="line"><span>   2263.4 ms  ✓ MAT</span></span>
<span class="line"><span>   1954.9 ms  ✓ ImageShow</span></span>
<span class="line"><span>   2248.7 ms  ✓ Chemfiles</span></span>
<span class="line"><span>  46759.2 ms  ✓ DataFrames</span></span>
<span class="line"><span>   1341.5 ms  ✓ Transducers → TransducersDataFramesExt</span></span>
<span class="line"><span>   1602.1 ms  ✓ BangBang → BangBangDataFramesExt</span></span>
<span class="line"><span>   9136.0 ms  ✓ MLDatasets</span></span>
<span class="line"><span>  58 dependencies successfully precompiled in 115 seconds. 146 already precompiled.</span></span>
<span class="line"><span>Precompiling SimpleChains...</span></span>
<span class="line"><span>    475.8 ms  ✓ StaticArrayInterface → StaticArrayInterfaceOffsetArraysExt</span></span>
<span class="line"><span>    767.8 ms  ✓ HostCPUFeatures</span></span>
<span class="line"><span>   7672.5 ms  ✓ VectorizationBase</span></span>
<span class="line"><span>   1034.2 ms  ✓ SLEEFPirates</span></span>
<span class="line"><span>   1209.6 ms  ✓ VectorizedRNG</span></span>
<span class="line"><span>    707.0 ms  ✓ VectorizedRNG → VectorizedRNGStaticArraysExt</span></span>
<span class="line"><span>  27529.9 ms  ✓ LoopVectorization</span></span>
<span class="line"><span>    981.4 ms  ✓ LoopVectorization → SpecialFunctionsExt</span></span>
<span class="line"><span>   1212.7 ms  ✓ LoopVectorization → ForwardDiffExt</span></span>
<span class="line"><span>   6022.9 ms  ✓ SimpleChains</span></span>
...
<span class="line"><span>   2361.0 ms  ✓ LuxLib → LuxLibSLEEFPiratesExt</span></span>
...
<span class="line"><span>  17396.9 ms  ✓ Reactant → ReactantOffsetArraysExt</span></span>
<span class="line"><span>  1 dependency successfully precompiled in 18 seconds. 82 already precompiled.</span></span>
<span class="line"><span>Precompiling LuxLibLoopVectorizationExt...</span></span>
<span class="line"><span>   4578.9 ms  ✓ LuxLib → LuxLibLoopVectorizationExt</span></span>
...
<span class="line"><span>   1860.9 ms  ✓ Lux → LuxSimpleChainsExt</span></span>
<span class="line"><span>  1 dependency successfully precompiled in 2 seconds. 122 already precompiled.</span></span>
<span class="line"><span>2025-07-08 04:38:35.076340: I external/xla/xla/service/service.cc:153] XLA service 0x15887870 initialized for platform CUDA (this does not guarantee that XLA will be used). Devices:</span></span>
<span class="line"><span>2025-07-08 04:38:35.076871: I external/xla/xla/service/service.cc:161]   StreamExecutor device (0): NVIDIA A100-PCIE-40GB MIG 1g.5gb, Compute Capability 8.0</span></span>
<span class="line"><span>WARNING: All log messages before absl::InitializeLog() is called are written to STDERR</span></span>
<span class="line"><span>I0000 00:00:1751949515.078434 4176590 se_gpu_pjrt_client.cc:1370] Using BFC allocator.</span></span>
<span class="line"><span>I0000 00:00:1751949515.078562 4176590 gpu_helpers.cc:136] XLA backend allocating 3825205248 bytes on device 0 for BFCAllocator.</span></span>
<span class="line"><span>I0000 00:00:1751949515.078768 4176590 gpu_helpers.cc:177] XLA backend will use up to 1275068416 bytes on device 0 for CollectiveBFCAllocator.</span></span>
<span class="line"><span>I0000 00:00:1751949515.094173 4176590 cuda_dnn.cc:471] Loaded cuDNN version 90800</span></span></code></pre></div><h2 id="Loading-MNIST" tabindex="-1">Loading MNIST <a class="header-anchor" href="#Loading-MNIST" aria-label="Permalink to &quot;Loading MNIST {#Loading-MNIST}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> loadmnist</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(batchsize, train_split)</span></span>
...
<span class="line"><span>          #        plus 0 states.</span></span></code></pre></div><p>We now need to convert the lux_model to SimpleChains.jl. We need to do this by defining the <a href="/v1/api/Lux/interop#Lux.ToSimpleChainsAdaptor"><code>ToSimpleChainsAdaptor</code></a> and providing the input dimensions.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">adaptor </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> ToSimpleChainsAdaptor</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">((</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">28</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">28</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">))</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>train (generic function with 2 methods)</span></span></code></pre></div><h2 id="Finally-Training-the-Model" tabindex="-1">Finally Training the Model <a class="header-anchor" href="#Finally-Training-the-Model" aria-label="Permalink to &quot;Finally Training the Model {#Finally-Training-the-Model}&quot;">​</a></h2><p>First we will train the Lux model</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">tr_acc, te_acc </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> train</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(lux_model, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">reactant_device</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">())</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[ 1/10] 	 Time 398.38s 	 Training Accuracy: 29.69% 	 Test Accuracy: 28.91%</span></span>
<span class="line"><span>[ 2/10] 	 Time 0.10s 	 Training Accuracy: 47.89% 	 Test Accuracy: 42.19%</span></span>
<span class="line"><span>[ 3/10] 	 Time 0.10s 	 Training Accuracy: 59.30% 	 Test Accuracy: 57.03%</span></span>
<span class="line"><span>[ 4/10] 	 Time 0.10s 	 Training Accuracy: 66.72% 	 Test Accuracy: 60.94%</span></span>
<span class="line"><span>[ 5/10] 	 Time 0.10s 	 Training Accuracy: 71.41% 	 Test Accuracy: 68.75%</span></span>
<span class="line"><span>[ 6/10] 	 Time 0.10s 	 Training Accuracy: 74.38% 	 Test Accuracy: 75.00%</span></span>
<span class="line"><span>[ 7/10] 	 Time 0.10s 	 Training Accuracy: 78.12% 	 Test Accuracy: 78.12%</span></span>
<span class="line"><span>[ 8/10] 	 Time 0.10s 	 Training Accuracy: 80.78% 	 Test Accuracy: 81.25%</span></span>
<span class="line"><span>[ 9/10] 	 Time 0.10s 	 Training Accuracy: 83.12% 	 Test Accuracy: 81.25%</span></span>
<span class="line"><span>[10/10] 	 Time 0.10s 	 Training Accuracy: 85.23% 	 Test Accuracy: 85.16%</span></span></code></pre></div><p>Now we will train the SimpleChains model</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">tr_acc, te_acc </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> train</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(simple_chains_model)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[ 1/10] 	 Time 898.71s 	 Training Accuracy: 34.69% 	 Test Accuracy: 36.72%</span></span>
<span class="line"><span>[ 2/10] 	 Time 12.26s 	 Training Accuracy: 56.09% 	 Test Accuracy: 52.34%</span></span>
<span class="line"><span>[ 3/10] 	 Time 12.24s 	 Training Accuracy: 63.98% 	 Test Accuracy: 64.06%</span></span>
<span class="line"><span>[ 4/10] 	 Time 12.23s 	 Training Accuracy: 71.41% 	 Test Accuracy: 73.44%</span></span>
<span class="line"><span>[ 5/10] 	 Time 12.24s 	 Training Accuracy: 76.25% 	 Test Accuracy: 76.56%</span></span>
<span class="line"><span>[ 6/10] 	 Time 12.24s 	 Training Accuracy: 80.31% 	 Test Accuracy: 81.25%</span></span>
<span class="line"><span>[ 7/10] 	 Time 12.24s 	 Training Accuracy: 84.14% 	 Test Accuracy: 78.91%</span></span>
<span class="line"><span>[ 8/10] 	 Time 12.24s 	 Training Accuracy: 85.78% 	 Test Accuracy: 82.81%</span></span>
<span class="line"><span>[ 9/10] 	 Time 12.24s 	 Training Accuracy: 88.28% 	 Test Accuracy: 83.59%</span></span>
<span class="line"><span>[10/10] 	 Time 12.23s 	 Training Accuracy: 89.38% 	 Test Accuracy: 82.81%</span></span></code></pre></div><p>On my local machine we see a 3-4x speedup when using SimpleChains.jl. The conditions of the server this documentation is being built on is not ideal for CPU benchmarking hence, the speedup may not be as significant and even there might be regressions.</p><h2 id="Appendix" tabindex="-1">Appendix <a class="header-anchor" href="#Appendix" aria-label="Permalink to &quot;Appendix {#Appendix}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> InteractiveUtils</span></span>
