# SimpleChains.jl
@grad_from_chainrules Lux.__apply_simple_chain(layer, x::TrackedArray, ps, ::CPUDevice)
@grad_from_chainrules Lux.__apply_simple_chain(layer, x, ps::TrackedArray, ::CPUDevice)
