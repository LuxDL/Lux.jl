...
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.D8oD4v8w.js"), true ? __vite__mapDeps([0,1]) : void 0));
