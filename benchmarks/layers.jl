...
run_benchmark_efl!(
    ExplicitFluxLayers.Conv((3, 3), 3 => 32; pad=SamePad(), stride=1), input_size, sum ∘ first; model_name, btimes
)
model_name = "Conv 32 x 32 x 3 => 32 x 32 x 16 (Input Size Fixed)"
run_benchmark_efl!(
    ExplicitFluxLayers.Conv((3, 3), 3 => 32; pad=SamePad(), stride=1, input_size=input_size[1:2]),
    input_size,
    sum ∘ first;
    model_name,
    btimes,
