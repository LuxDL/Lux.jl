...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>get_dataloaders (generic function with 1 method)</span></span></code></pre></div><h2 id="Creating-a-Classifier" tabindex="-1">Creating a Classifier <a class="header-anchor" href="#Creating-a-Classifier" aria-label="Permalink to &quot;Creating a Classifier {#Creating-a-Classifier}&quot;">​</a></h2><p>We will be extending the <code>Lux.AbstractExplicitContainerLayer</code> type for our custom model since it will contain a lstm block and a classifier head.</p><p>We pass the fieldnames <code>lstm_cell</code> and <code>classifier</code> to the type to ensure that the parameters and states are automatically populated and we don&#39;t have to define <code>Lux.initialparameters</code> and <code>Lux.initialstates</code>.</p><p>To understand more about container layers, please look at <a href="/previews/PR821/manual/interface#Container-Layer">Container Layer</a>.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">struct</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> SpiralClassifier{L, C} </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&lt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><p>We won&#39;t define the model from scratch but rather use the <a href="/previews/PR821/api/Lux/layers#Lux.LSTMCell"><code>Lux.LSTMCell</code></a> and <a href="/previews/PR821/api/Lux/layers#Lux.Dense"><code>Lux.Dense</code></a>.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> SpiralClassifier</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(in_dims, hidden_dims, out_dims)</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><h2 id="Using-the-@compact-API" tabindex="-1">Using the <code>@compact</code> API <a class="header-anchor" href="#Using-the-@compact-API" aria-label="Permalink to &quot;Using the \`@compact\` API {#Using-the-@compact-API}&quot;">​</a></h2><p>We can also define the model using the <a href="/previews/PR821/api/Lux/utilities#Lux.@compact"><code>Lux.@compact</code></a> API, which is a more concise way of defining models. This macro automatically handles the boilerplate code for you and as such we recommend this way of defining custom layers</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> SpiralClassifierCompact</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(in_dims, hidden_dims, out_dims)</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ps_trained, st_trained </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> main</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(SpiralClassifier)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Epoch [  1]: Loss 0.56303</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.51719</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.47881</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.45124</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.42112</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.40749</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.37520</span></span>
<span class="line"><span>Validation: Loss 0.36772 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.37210 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.37605</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.35330</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.33785</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.31082</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.30269</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.28592</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.27849</span></span>
<span class="line"><span>Validation: Loss 0.25786 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.26114 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.25746</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.24583</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.23407</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.22217</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.20849</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.20458</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.18399</span></span>
<span class="line"><span>Validation: Loss 0.17996 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.18193 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.18171</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.17082</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.16266</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.15778</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.14889</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.14038</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.13588</span></span>
<span class="line"><span>Validation: Loss 0.12836 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.12970 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.12820</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.12406</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.11776</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.11090</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.10701</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.10167</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.10344</span></span>
<span class="line"><span>Validation: Loss 0.09323 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.09434 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.09174</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.08998</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.08635</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.08398</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.07859</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.07399</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.07352</span></span>
<span class="line"><span>Validation: Loss 0.06873 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.06968 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.06884</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.06687</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.06440</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.05908</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.05949</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.05584</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.05308</span></span>
<span class="line"><span>Validation: Loss 0.05121 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.05204 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.05118</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.04898</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.04879</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.04526</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.04341</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.04267</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.03966</span></span>
<span class="line"><span>Validation: Loss 0.03845 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.03920 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03847</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03860</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03558</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03471</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03195</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03188</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03270</span></span>
<span class="line"><span>Validation: Loss 0.02931 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.02998 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 10]: Loss 0.02933</span></span>
<span class="line"><span>Epoch [ 10]: Loss 0.02764</span></span>
<span class="line"><span>Epoch [ 10]: Loss 0.02695</span></span>
...
<span class="line"><span>Epoch [ 10]: Loss 0.02470</span></span>
...
<span class="line"><span>Epoch [ 11]: Loss 0.02103</span></span>
...
<span class="line"><span>Epoch [ 12]: Loss 0.02009</span></span>
...
<span class="line"><span>Epoch [ 15]: Loss 0.01229</span></span>
...
<span class="line"><span>Epoch [ 16]: Loss 0.00906</span></span>
...
<span class="line"><span>Epoch [ 17]: Loss 0.00839</span></span>
<span class="line"><span>Epoch [ 17]: Loss 0.00990</span></span>
<span class="line"><span>Epoch [ 17]: Loss 0.00951</span></span>
<span class="line"><span>Epoch [ 17]: Loss 0.00856</span></span>
...
<span class="line"><span>Epoch [ 19]: Loss 0.00739</span></span>
...
<span class="line"><span>Epoch [ 20]: Loss 0.00627</span></span>
...
<span class="line"><span>Epoch [ 24]: Loss 0.00464</span></span>
...
<span class="line"><span>Validation: Loss 0.00523 Accuracy 1.00000</span></span></code></pre></div><p>We can also train the compact model with the exact same code!</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ps_trained2, st_trained2 </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> main</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(SpiralClassifierCompact)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Epoch [  1]: Loss 0.56406</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.50727</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.47245</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.44140</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.42919</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.40925</span></span>
<span class="line"><span>Epoch [  1]: Loss 0.39331</span></span>
<span class="line"><span>Validation: Loss 0.36742 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.35999 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.36360</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.35402</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.33955</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.32130</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.29527</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.28403</span></span>
<span class="line"><span>Epoch [  2]: Loss 0.26475</span></span>
<span class="line"><span>Validation: Loss 0.25733 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.25267 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.25276</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.24257</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.23406</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.22169</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.20861</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.20269</span></span>
<span class="line"><span>Epoch [  3]: Loss 0.18714</span></span>
<span class="line"><span>Validation: Loss 0.17969 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.17684 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.17698</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.17058</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.16342</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.15508</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.14820</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.14303</span></span>
<span class="line"><span>Epoch [  4]: Loss 0.13190</span></span>
...
<span class="line"><span>Epoch [  5]: Loss 0.12836</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.12401</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.11632</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.11072</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.10576</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.10278</span></span>
<span class="line"><span>Epoch [  5]: Loss 0.09640</span></span>
<span class="line"><span>Validation: Loss 0.09313 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.09136 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.09196</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.08822</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.08720</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.08104</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.08060</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.07418</span></span>
<span class="line"><span>Epoch [  6]: Loss 0.07042</span></span>
<span class="line"><span>Validation: Loss 0.06872 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.06702 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.06827</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.06649</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.06383</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.06102</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.05804</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.05528</span></span>
<span class="line"><span>Epoch [  7]: Loss 0.05361</span></span>
<span class="line"><span>Validation: Loss 0.05128 Accuracy 1.00000</span></span>
<span class="line"><span>Validation: Loss 0.04970 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.05058</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.04948</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.04870</span></span>
<span class="line"><span>Epoch [  8]: Loss 0.04607</span></span>
...
<span class="line"><span>Epoch [  9]: Loss 0.03840</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03498</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03512</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03258</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03214</span></span>
<span class="line"><span>Epoch [  9]: Loss 0.03063</span></span>
<span class="line"><span>Validation: Loss 0.02949 Accuracy 1.00000</span></span>
...
<span class="line"><span>Epoch [ 10]: Loss 0.02648</span></span>
...
<span class="line"><span>Epoch [ 11]: Loss 0.02263</span></span>
...
<span class="line"><span>Epoch [ 11]: Loss 0.01944</span></span>
...
<span class="line"><span>Epoch [ 12]: Loss 0.01891</span></span>
...
<span class="line"><span>Epoch [ 13]: Loss 0.01548</span></span>
...
<span class="line"><span>Epoch [ 14]: Loss 0.01226</span></span>
...
<span class="line"><span>Validation: Loss 0.01021 Accuracy 1.00000</span></span>
...
<span class="line"><span>Validation: Loss 0.00773 Accuracy 1.00000</span></span>
<span class="line"><span>Epoch [ 19]: Loss 0.00910</span></span>
...
<span class="line"><span>Epoch [ 23]: Loss 0.00526</span></span>
