---
url: /previews/PR1691/manual/nested_autodiff.md
---
...
```ansi
(nothing, Float32[-0.55306894 0.15707001 … -8.553632 0.07513549], (layer_1 = (weight = Float32[-1.3108878; -2.4101038; … ; 0.43676835; 1.9626999;;], bias = Float32[-1.77037, 1.783425, -7.107933, -3.4437153, 3.261593, -1.9511775, 11.527171, -1.8003643, 6.7513776, -4.7700396, -3.1833076, 6.5878158]), layer_2 = (weight = Float32[-0.23921253 -0.20668773 … -0.6383876 -2.23242; -1.6666821 1.0425432 … -1.640935 -3.4007294; … ; -0.36023283 -0.086430214 … -0.70545524 -2.192126; 3.1173706 -1.9727281 … 3.040209 6.11373], bias = Float32[0.37292385, -2.9340096, 3.6637251, -0.7247124, -0.79250365, -1.1245009, -0.89858973, -0.0328466, -2.729647, -8.446214, 0.062080674, 5.536761]), layer_3 = (weight = Float32[-0.7262077 1.0381728 … -1.5016018 -1.679885; 2.2896144 0.43350348 … -1.6663246 -1.8067698; … ; -2.1851234 -0.6424198 … 1.9577403 2.1489012; 0.3654292 -0.09699093 … 0.025357664 0.028738916], bias = Float32[1.1350523, -2.1769385, 4.114976, 3.2841997, 0.35638642, 3.7911117, -0.007984852, -2.0338566, -1.1642131, -2.9500434, 2.0285954, -0.41238895]), layer_4 = (weight = Float32[15.794909 -20.65178 … -7.7980285 -9.910249], bias = Float32[11.461397])), nothing)
```
...
```ansi
(nothing, Float32[6.8464594 6.2111297 … 1.9693899 -1.959182], (layer_1 = (weight = Float32[-3.6867144; -1.6853899; … ; 2.95014; -6.6372194;;], bias = Float32[-6.4886236, -7.066128, 1.3344339, 2.6049256, 0.7290938, -15.730943, -5.4314566, 7.4604826, -1.1864493, 15.522136, 0.44571507, -15.376385]), layer_2 = (weight = Float32[0.39800453 -4.3071294 … -1.0914631 -4.759412; 0.8852217 -2.2523665 … 0.39773178 0.13067567; … ; -2.2192001 0.88214767 … -0.5598971 1.3939896; -3.1545162 4.594261 … -1.7649313 -0.3824194], bias = Float32[7.5247803, 4.2529235, -17.252981, 3.260692, -7.4066525, 1.1126353, 2.847105, 6.7544622, -9.815337, 0.18652117, -4.5365167, -10.04811]), layer_3 = (weight = Float32[1.0462949 4.8999977 … 1.1557573 -2.284967; -2.3719282 8.687264 … -3.1904755 -8.841231; … ; -10.298788 -2.9139607 … -9.754746 -4.038132; 1.2221471 -0.46878594 … 1.0469306 0.9091032], bias = Float32[2.837991, 8.345026, 2.9214199, -2.2415924, -11.139433, -3.834073, -2.845412, -7.916489, 4.2225285, -1.2864518, 6.9338737, -1.4144738]), layer_4 = (weight = Float32[-59.44397 -12.688666 … 99.77208 -3.339081], bias = Float32[0.0])), nothing)
```
...
```ansi
∞-norm(∂x - ∂x_fd): 2.1457672e-6
∞-norm(∂ps - ∂ps_fd): 2.1219254e-5
```
